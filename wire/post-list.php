<?php do_action( 'bp_before_wire_post_list_content' ) ?>
	...
	<div class="bp-widget">
            <h4><?php bp_wire_title() ?> <span class="wire-feed"><a href="<?php echo bp_wire_get_feed_link();?>">Feed</a></span><!-- <span><a href="<?php bp_wire_see_all_link() ?>"><?php _e( "See All", "bp-wire" ) ?> &rarr;</a></span>--></h4>
		...
		<?php while ( bp_wire_posts() ) : bp_the_wire_post(); ?>
				...
				<div class='wire-content'>
					...
					<span class='wire-date-del'>
						<?php printf ( __( '%1$s', "bp-wire" ), bp_get_wire_post_date()) ?>
